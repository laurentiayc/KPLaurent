  ...
  <div class="col_two_third">
    ...
    <div class="col_half">
      ...
      <div class="widget clearfix">
        <h4>
            CU {{ ucwords(str_replace('-', ' ', $subdomain)) }}
        </h4>
        <address>
                <strong>Kantor:</strong><br>
                        {{ $cu->alamat }}
            </address>
            <abbr title="Phone Number"><strong>No. Telp:</strong></abbr> {{ $cu->telp }}<br>
            <abbr title="Phone Number"><strong>No. HP:</strong></abbr> {{ $cu->telp }}<br>
            <abbr title="Email Address"><strong>Email:</strong></abbr> {{ $cu-> email }}<br>
            <abbr title="Website"><strong>Website:</strong></abbr> {{ $cu->website }}<br>
      </div>
    ...
    <div class="widget clearfix" style="margin-bottom: -20px;">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 bottommargin-sm">
          <div class="counter counter-small"><span data-from="50" data-to="{{ $manajemenCUCount }}" data-refresh-interval="100" data-speed="2000" data-comma="true"></span></div>
          <h5 class="nobottommargin">Manajemen CU {{ ucwords(str_replace('-', ' ', $subdomain)) }}</h5>
        </div> 
