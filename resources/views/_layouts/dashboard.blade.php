...
<head>
  ...
  <link href="{{asset('dashboard_assets/css/paper-dashboard.css?v=2.0.1')}}" rel="stylesheet" />
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="{{asset('dashboard_assets/demo/demo.css')}}" rel="stylesheet" />
</head>
<body>
...
<script src="{{asset('dashboard_assets/js/core/jquery.min.js')}}"></script>
  ...
  <script src="{{asset('dashboard_assets/js/plugins/bootstrap-notify.js')}}"></script>
  <!-- Control Center for Now Ui Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="{{asset('dashboard_assets/js/paper-dashboard.min.js?v=2.0.1')}}" type="text/javascript"></script><!-- Paper Dashboard DEMO methods, don't include it in your project! -->
  <script src="{{asset('dashboard_assets/demo/demo.js')}}"></script>
  <script>
    $(document).ready(function() {
      // Javascript method's body can be found in dashboard_assets/dashboard_assets-for-demo/js/demo.js
