        ...
        <div class="entry clearfix">
          ...
          <div class="entry-content">
              ...
              @if(!empty($item->aturan_setor))
                <strong>Aturan Setor:</strong> {!! $item->aturan_setor !!} <br>
              @endif 
              @if(!empty($item->aturan_tarik))
                <strong>Aturan Tarik:</strong> {!! $item->aturan_tarik !!} <br>
              @endif
              @if(!empty($item->aturan_balas_jasa))
                <strong>Aturan Balas Jasa:</strong> {!! $item->aturan_balas_jasa !!} <br>
              @endif 
              @if(!empty($item->aturan_lain))
                <strong>Aturan Lain:</strong> {!! $item->aturan_lain !!} <br>
              @endif        
          </div>
        </div>
        @endforeach
